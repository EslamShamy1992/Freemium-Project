...
test.describe('Machine Parameters Tests', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    dataType = faker.helpers.arrayElement(['Int', 'Float', 'String']);
  ...
  test('Add new Machine Parameter with dynamic data', async ({ page }) => {
    ...
    await machineParametersPage.assertParameterAdded();
  });
  ...
  test('Update Machine Parameter with dynamic data', async ({ page }) => {
    ...
    await machineParametersPage.assertParameterUpdated();
    console.log('Machine Parameter Updated:', updatedParameterName, updatedSamplingInterval);
  });
  ...
  test('Delete Machine Parameter with dynamic data', async ({ page }) => {
    ...
    await machineParametersPage.addMachineParameter(machineName, parameterName, samplingInterval, dataType);
    await machineParametersPage.assertParameterAdded();
    console.log('Machine Parameter Added for Delete Test:', machineName, parameterName, samplingInterval, dataType);
    
    await machineParametersPage.deleteMachineParameter();
    await machineParametersPage.assertParameterDeleted();
    console.log('Machine Parameter Deleted');
  });
});
